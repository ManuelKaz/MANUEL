...
module.exports = {
    ...
    OWN_NUMBER: process.env.OWNER_NUMBER === undefined ? '265994277623' : process.env.OWN_NUMBER,
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'MANUEL' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? '[MANUEL BOT 😎] - ᎷᎠ' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? '265994277623' : process.env.ST_PKG,
